    ...
    private class Position : IPosition
    {
        ...
        public Rectangle CalculateTooltipPosition(Rectangle tooltipBounds, Vector2 iconSize)
        {
            return new(
                ...
                CalculateTooltipPosition(_horizontalPosition is Middle && _verticalPosition is Leading, tooltipBounds.Y,
                    iconSize.Y),
                CalculateTooltipSize(_horizontalPosition is Leading or Trailing, tooltipBounds.Width, iconSize.X),
                CalculateTooltipSize(_horizontalPosition is Middle && _verticalPosition is Leading or Trailing,
                    tooltipBounds.Height, iconSize.Y)
            );
        }
